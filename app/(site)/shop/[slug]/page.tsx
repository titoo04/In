    ...
    <div className="bg-black">
      <section className="relative overflow-hidden bg-black text-white">
        ...
        <div className="relative mx-auto flex w-full max-w-5xl flex-col gap-4 px-16 py-16">
          <h1 className=" uppercase  --font-display text-center leading-tight font-light self-center">
            {state.description}
          </h1>
        </div>
      </section>
      <section className="mx-auto w-full max-w-5xl px-6 py-16">
        ...
        <div className="mt-12 flex flex-col items-center gap-6 text-center text-white">
          <Link className="pillar bg-[#D86A5A] uppercase py-3 px-9" href="/products">
            View all
          </Link>
          ...
          <Link className="text-sm text-white/80 uppercase font-medium self-start " href="/where-are-you-now">
            &lt; Back
          </Link>
        </div>
      </section>
